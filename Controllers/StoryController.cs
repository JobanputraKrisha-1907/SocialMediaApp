...
namespace SMWebApplication.Controllers
{
    public class StoryController : ApiController
    {
        ...
        [HttpPost]
        [Route("api/Story/UploadAndPostStory")]
        public HttpResponseMessage UploadAndPostStory(int userId)
        {
            ...
            try
            {
                ...
                SaveImagePathToDatabase(filePath, userId);
        ...
        private void SaveImagePathToDatabase(string imagePath, int userId)
        {
            ...
            try
            {
                ...
                using (SqlCommand command = new SqlCommand("INSERT INTO Stories (UserID, MediaType, MediaURL) VALUES (@UserID, @MediaType, @MediaURL)", connection))
                {
                    command.Parameters.AddWithValue("@UserID", userId);
                    command.Parameters.AddWithValue("@MediaType", "image");
        ...
        private void SaveStoryToDatabase2(int userId,string mediaType, string imagePath, DateTime StoryExpiryTimestamp)
        {
            try
            {
                ...
                {
                    var command = new SqlCommand("INSERT INTO [Instagram001].[dbo].[Stories] (UserID, MediaType, MediaURL, StoryExpiryTimestamp) VALUES (@UserId, @MediaType, @MediaURL, @StoryExpiryTimestamp)", connection);
